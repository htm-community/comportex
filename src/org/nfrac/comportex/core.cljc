    ...
    (into {}
          (map (fn [cell-id]
                 (let [[col ci] cell-id
                       ...
                       [ff-seg-path _] (get (:fully-matching-ff-seg-paths state) [col 0])
                       ...
                       [d-seg-path _] (get (:fully-matching-seg-paths distal-state) cell-id)
                       ...
                       ;; same for apical
                       [a-seg-path _] (get (:fully-matching-seg-paths apical-state) cell-id)
